...
namespace FormUsuario
{
    public partial class Menu : Form
    {
        ...
        private void Menu_Load(object sender, EventArgs e)
        {
            ...
            reporteDeUsuarioToolStripMenuItem.Visible = login.UsuarioAutenticado.PuedeVerReportedeUsuario;
        }
        ...
        {
            var formReporteUsuario = new FormReporteUsuario();


            formReporteUsuario.Show();
        }
    }
}
